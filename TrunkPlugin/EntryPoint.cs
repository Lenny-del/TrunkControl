...
namespace TrunkPlugin
{
    public class EntryPoint
    {
        public static void Main()
        {
            ...
            Game.DisplayNotification("web_lossantospolicedept", "web_lossantospolicedept", "TrunkPlugin", "~y~v" + Assembly.GetExecutingAssembly().GetName().Version.ToString() + " ~o~by Vielfalt", "~w~Installed version: ~g~" + curVersion + "<br>~w~Latest Version: ~r~" + receivedData + "<br>~w~Loaded ~g~succesfully! "); 
